...
final class Remote {
    record Source(String name, String installed, String type, String id, String asset) {}
    record Release(String version, String download, String page) {}
    ...
    static InputStream open(String url) throws IOException {
        ...
        for (int redirects = 0; redirects < 6; redirects++) {
            ...
            c.setRequestProperty("User-Agent", "PluginUpdateWatch/1.0.0");
    ...
    static Release latest(Source s) throws IOException {
        ...
        throw new IOException("Source must be spigot or github");
    }
